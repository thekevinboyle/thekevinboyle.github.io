...
if ($SUCCESS)
{
	...
	$formcontent = '';
	$emailtemplate = "<html><head><title>Stephanie &amp; Alex</title></head><body><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"200\" style=\"background:#593875; align:center\"><tr><td style=\"vertical-align:top; padding:0; width:200px\"></td><td style=\"vertical-align:top; padding:0;\"><table style=\"width:650px; margin:70px auto; border-collapse:collapse; font:13px sans-serif;\"><tr><td style=\"vertical-align:top; padding:0; height:70px\">&nbsp;</td></tr><tr><td style=\"vertical-align:top; padding:0; padding:0\"><table style=\"width:100%; border-collapse:collapse; border:1px solid #241f1c; border-bottom-color:#6c5d53; border-top-color:#6c5d53; font-size:13px\"><tr style=\"background:white\"><!-- top stripe --><td background=\"http://formbakery.com/stripe.png\" style=\"vertical-align:top; padding:0; background:url(http://formbakery.com/stripe.png) left top no-repeat;\" colspan=\"2\">&nbsp;</td></tr><tr style=\"background:white;\"><td colspan=\"2\" style=\"vertical-align:top; padding:0; padding:40px; font-size:21px; font-weight:bold\">Stephanie &amp; Alex</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Attending:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['attending']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Name:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['name']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Email:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['email']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Meal Options:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['meal-options']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Comments:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['comments']['value']}</td></tr><tr style=\"background:white; padding-bottom:40px\"><td colspan=\"2\" style=\"vertical-align:top; padding:0; padding:40px\">&nbsp;</td></tr></table></td></tr><tr><td style=\"vertical-align:top; padding:0; background:#e3dedb; height:1px; line-height:1px; padding:0; border:10px solid #593875; border-top:0; border-bottom:0\">&nbsp;</td></tr><tr><td style=\"vertical-align:top; padding:0; height:100px\">&nbsp;</td></tr></table></td><td style=\"vertical-align:top; padding:0; width:200px\"></td></tr></table></body></html>";
	...
	$recipient = 'courtneylorrainecox@gmail.com';
	$subject = 'Stephanie &amp; Alex';
	$mailheader = "From: Unknown Sender \r\nContent-Type: text/html;";
